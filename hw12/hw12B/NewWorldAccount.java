...
public class NewWorldAccount extends BankAccount{
	...
	public boolean equals(Object otherObject){
		...
		if(otherObject instanceof NewWorldAccount) {
			NewWorldAccount other = (NewWorldAccount)otherObject;
			if(other.getTimeToMaturity() == maturity)
				return true;
		}
		return false;
	}
